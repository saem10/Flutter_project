...
class _ProductListState extends State<ProductList> {
  List<Product> products = [
    Product("Product 1", 220.0),
    Product("Product 2", 400.0),
    Product("Product 3", 1000.0),
    Product("Product 4", 100.0),
    Product("Product 5", 85.0),
    Product("Product 6", 340.0),
    Product("Product 7", 760.0),
    Product("Product 8", 650.0),
    Product("Product 9", 440.0),
    Product("Product 10", 1199.0),
